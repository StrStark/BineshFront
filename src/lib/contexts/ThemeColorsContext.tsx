...
export function ThemeColorsProvider({ children }: { children: ReactNode }) {
  const [currentTheme, setCurrentTheme] = useState<"default" | "hafez">("default");
  const [pendingTheme, setPendingTheme] = useState<"default" | "hafez">("default");
  ...
  useEffect(() => {
    ...
    if (savedTheme) {
      setCurrentTheme(savedTheme as "default" | "hafez");
      setPendingTheme(savedTheme as "default" | "hafez");
    }
