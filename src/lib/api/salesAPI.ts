...
export const salesAPI = {
  async getSalesSummary(request: SalesSummaryRequest): Promise<SalesSummaryResponse> {
    ...
    try {
      ...
      const data = await apiPost<SalesSummaryResponse>('/api/sales/summary', request);
      return data;
    } catch (error: any) {
  ...
  async getCustomerCategorizedSales(request: SalesSummaryRequest): Promise<CustomerCategorizedSalesResponse> {
    ...
    try {
      // Using apiPost with automatic token refresh
      const data = await apiPost<CustomerCategorizedSalesResponse>('/api/sales/customer-categorized', request);
      return data;
    } catch (error: any) {
  ...
  async getSalesRecords(request: SalesRecordsRequest): Promise<SalesRecordsResponse> {
    ...
    try {
      // Using apiPost with automatic token refresh
      const data = await apiPost<SalesRecordsResponse>('/api/sales/records', request);
      return data;
    } catch (error: any) {
  ...
  async getTopSellingProducts(request: SalesSummaryRequest): Promise<TopSellingProductsResponse> {
    ...
    try {
      // Using apiPost with automatic token refresh
      const data = await apiPost<TopSellingProductsResponse>('/api/sales/top-products', request);
      return data;
    } catch (error: any) {
