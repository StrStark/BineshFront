import svgPaths from "./svg-ijbz21z9ho";
...
import imgImage177 from "figma:asset/9336da2279054b5baee609eb19a9d98b63ce4df0.png";
type TextProps = {
  text: string;
};
...
function Group3() {
  return (
    <div className="absolute contents left-[calc(50%+1.5px)] top-[896px] translate-x-[-50%]">
      <p className="absolute font-['Yekan_Bakh_FaNum:Regular',sans-serif] h-[23px] leading-[normal] left-[calc(50%+4.5px)] not-italic text-[20px] text-center text-white top-[896px] translate-x-[-50%] w-[155px]" dir="auto">
        افزودن و حذف
      </p>
      <div className="absolute flex h-[4px] items-center justify-center left-[545px] top-[908px] w-[10px]">
          ...
          <div className="h-[4px] relative w-[10px]">
            <div className="absolute inset-[-10.11%_-2.94%_8.66%_-3.32%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6263 4.05792">
                <path d={svgPaths.pb417d00} id="Line 338" stroke="var(--stroke-0, white)" />
              </svg>
            </div>
          </div>
        </div>
...
function Group2() {
  return (
    <div className="absolute contents left-[calc(50%-0.5px)] top-[889px] translate-x-[-50%]">
      <div className="absolute bg-[#0e1b27] h-[38px] left-[479px] rounded-tl-[20px] rounded-tr-[20px] top-[889px] w-[289px]" />
      <Group3 />
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="absolute h-[927px] left-0 overflow-clip top-[73px] w-[1248px]">
      <div className="absolute aspect-[1230/713] left-[1.92%] right-[3.61%] top-[82px]" data-name="image 177">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage177} />
      </div>
      <Group2 />
    </div>
  );
